...
function ajouter_styles() {
    wp_enqueue_style('31w-style-principal', // id de la feuille de style
                get_template_directory_uri() . '/sass/style.css', // adresse url de la feuille de style
                array(), // les dépendances avec les autres feuilles de style
                filemtime(get_template_directory() . '/sass/style.css')); // la de la dernière feuille de style
}
...
//add_filter('nav_menu_item_title', 'perso_menu_item_title', 10, 2);
